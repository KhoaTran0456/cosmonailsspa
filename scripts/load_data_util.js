...
function loadDataForIndex(cgf) {
	...
	$.each(cgf.specialties, function (count, spe) {
			...
			'                                    <li><a data-facebook class="btn btn-success text-white" target="_blank" href="https://www.facebook.com/CosmoNailsMurphy"><i'+
			'                                                class="fab fa-facebook"></i></a></li>'+
			'                                    <li><a data-instagram class="btn btn-success text-white mt-2" target="_blank" href="https://www.instagram.com/cosmonailsandspain"><i'+
			'                                                class="fab fa-instagram"></i></a></li>'+
			'                                    <li><a data-google class="btn btn-success text-white mt-2" target="_blank" href="https://goo.gl/maps/j7DbrasDgdjP1vdC6"><i'+
	...
	$.each(cgf.categories, function (count, cat) {
		if (cat.home == true) {
			...
			var strColElement = '<div class="col-lg-3 col-md-6 all des">' +
				...
				'                                        <img src="CAT_SRC" alt="Cosmo Nails & Spa"></a>' +
...
function loadDataForServices(cgf) {
	...
	$.each(cgf.categories, function (count, cat) {
		...
		'                    <img class="w-100" src="CAT_SRC" alt="Cosmo Nails & Spa">'+
		''+
		'                </div>'+
		'                <div class="col-md-9">'+
		'                    <div class="row">'+
...
function loadDataForGallery(cgf) {
	...
	$.each(cgf.gallery, function (count, gal) {
			...
			'                  <div class="thumbnail">'+
			'                    <a href="IMAGE_SRC">'+
			'                      <img src="IMAGE_SRC" alt="Cosmo Nails & Spa" style="width:100%">'+
			'                    </a>'+
			'                  </div>'+
			'                </div>';
...
function loadDataForSpecialties(cgf) {
	...
	$.each(cgf.specialties, function (count, spe) {
			...
			'                                        href="https://www.facebook.com/CosmoNailsMurphy"><i'+
			'                                            class="fab fa-facebook"></i></a></li>'+
			'                                <li><a class="btn btn-success text-white mt-2" target="_blank"'+
			'                                        href="https://www.instagram.com/cosmonailsandspain"><i'+
			'                                            class="fab fa-instagram"></i></a></li>'+
			'                                <li><a class="btn btn-success text-white mt-2" target="_blank"'+
			'                                        href="https://goo.gl/maps/j7DbrasDgdjP1vdC6" data-google><i class="fab fa-google"></i></a>'+
			'                                </li>'+
			'                            </ul>'+
			'                        </div>'+
			'                    </div>'+
